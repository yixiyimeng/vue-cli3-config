	...
	created() {
		...
		this.localPagination = ['auto', true].includes(this.showPagination) && Object.assign({}, this.localPagination, {
			...
			showTotal: function(total, range) {
				return `从第${range[0]}条到${range[1]}条，总计：${total}条`
			},
				...
				result.then(r => {
					if (this.showPagination) {
						this.localPagination = Object.assign({}, this.localPagination, {
							current: r.pageNum ? r.pageNum : ((pagination && pagination.current) || this.localPagination.current || this
								.pageNum), // 返回结果中的当前分页数
						...
						(!this.showPagination || !r.total && this.showPagination === 'auto') && (this.localPagination.hideOnSinglePage =
							true)
					}
